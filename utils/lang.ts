...
export const lang: KeyObjectMap = {
  ...
  tr: {
    ...
    MIN_READ: `dk okuma`,
    MORE_IN: `Daha fazla`,
    MORE_POSTS: `Diğer yazılar`,
    MORE_POSTS_SM: `diğer yazılar`,
    NEXT: `Sonraki`,
    NO_POSTS: `Yazı yok`,
    ...
    READ: `Oku`,
    SEE_ALL: `Hepsini gör`,
    SUBSCRIBED_TO: `Başarılı bir şekilde abone oldunuz`,
    WEBSITE: `Website`,
    MULTIPLE_AUTHORS: `Yazarlar`,
    DARK_MODE: `KoyuMod`,
    CHECK_YOUR_INBOX: `Emailinizi kontrol edin ve üyeliğinizi tamamlamak için linki tıklayın`,
    EMAIL: `Email`,
    ENTER_VALID_EMAIL: `Lütfen geçerli bir mail adresi giriniz`,
    GREAT: `Harika`,
    SUBSCRIBE: `AboneOl`,
    SUBSCRIBE_OVERLAY: `Stay up to date! Get all the latest & greatest posts delivered straight to your inbox`,
    SUBSCRIBE_SECTION: `Yayımlanan yazılar doğrudan mail adresinize gelsin!`,
    SUBSCRIBE_TO: `Aboneliğinizi başlatın! `,
    SUBSCRIBED_FAILED: `Üyelik başarısız! Geçersiz üyelik linki.`,
    YOUR_EMAIL: `youremail@example.com`,
    AT_LEAST: `en az`,
    CHARACTERS_LONG: `karakter uzunluğunda olmalıdır`,
    CHARACTERS_OR_LESS: `karakter veya daha az`,
    EMAIL_ADDRESS: `Email Adresiniz`,
    EMAIL_IS_REQUIRED: `Email Adresiniz gereklidir`,
    FULL_NAME: `İsminiz`,
    FULL_NAME_REQUIRED: `İsminiz gereklidir`,
    FULL_NAME_MUST_BE: `İsminiz`,
    INVALID_EMAIL_ADDRESS: `Geçersiz email adresi`,
    MESSAGE_MUST_BE: `Mesajınız`,
    MESSAGE_SENT: `Teşekkürler, mesajınız gönderildi!`,
    MESSAGE_TEXT_IS_REQUIRED: `Bir mesaj metni gereklidir`,
    ONE_SECOND: `Bir saniye lütfen...`,
    SENDING_FAILED: `Oops :-( gönderme başarısız. Hata`,
    PLEASE_SELECT: `Lütfen seçiniz...`,
    PLEASE_SELECT_SUBJECT: `Lütfen bir konu seçiniz`,
    SUBMIT: `Gönder`,
